...
!! TOPOL
INTEGER::num_ats,num_nods,num_categories,num_sets

INTEGER,DIMENSION(:),ALLOCATABLE::at2nod,in_at_nod,num_ats_nod
INTEGER,DIMENSION(:),ALLOCATABLE::symm_ats_crits,symm_ats_start,symm_ats_ind
INTEGER,DIMENSION(:),ALLOCATABLE::nod_cat,nod2set,nod2posinset
INTEGER,DIMENSION(:),ALLOCATABLE::at_cat,at2set,at2posinset
...
INTEGER,DIMENSION(:),ALLOCATABLE::in_Hbs_at,in_Bs_at,Hbs,Bs
INTEGER,DIMENSION(:),ALLOCATABLE::Hbs_at,Bs_at
INTEGER,DIMENSION(:),ALLOCATABLE::Hbs_nod,Bs_nod

!! To microstates

INTEGER,DIMENSION(:),ALLOCATABLE::symm_aux_ats
INTEGER,DIMENSION(:),ALLOCATABLE::symm_aux_nods
INTEGER,DIMENSION(:),ALLOCATABLE::symm_aux_sets

INTEGER,DIMENSION(:),ALLOCATABLE::mss_ind_ats,mss_ind_nods,mss_symm,mss


CONTAINS

SUBROUTINE load_topol(xx_at2nod,xx_in_at_node,xx_num_ats_nod,&
     xx_symm_ats_crits,xx_symm_ats_start,xx_symm_ats_ind,&
     xx_nod_cat)
